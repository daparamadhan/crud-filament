...
<section class="flex items-center justify-center pt-24 pb-16 px-4 bg-cover bg-center"
  ...
  <div class="text-center max-w-xl space-y-4">
    ...
    <p class="text-white text-base">Find the right shipping solution for your needs—fast, safe, and reliable.</p>
    <div class="flex w-full max-w-md mx-auto rounded-xl overflow-hidden border border-white">
      ...
      <button class="h-12 px-4 bg-[#47c1ea] text-white font-bold text-sm tracking-wide hover:bg-[#3bb2d5] transition">Search</button>
    </div>
  </div>
</section>
...
<section class="py-12 px-10 max-w-3xl mx-auto text-center">
  ...
  <a href="<?php echo e(route('shipments.index')); ?>" class="inline-block bg-[#47c1ea] text-white font-bold px-6 py-3 rounded-xl hover:bg-[#3bb2d5] transition">
    Get Started
  </a>
</section>
  ...
  <div class="max-w-6xl mx-auto grid md:grid-cols-4 gap-10 px-6 pb-16">
    ...
    <div>
      ...
      <ul class="space-y-2 text-sm">
        ...
        <li><a href="<?php echo e(route('services')); ?>" class="hover:underline">Services</a></li>
...
</html><?php /**PATH G:\crud-filament\crud-filament\resources\views/services.blade.php ENDPATH**/ ?>