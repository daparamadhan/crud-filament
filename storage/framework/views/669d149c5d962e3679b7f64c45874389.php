...
<section class="flex items-center justify-center py-16 px-4 bg-cover bg-center"
  ...
  <div class="text-center max-w-xl space-y-4">
    ...
    <div class="flex w-full max-w-md mx-auto rounded-xl overflow-hidden">
      <a href="<?php echo e(route('services')); ?>" role="button" class="w-full h-12 px-4 flex items-center justify-center bg-[#47c1ea] text-white font-bold text-sm tracking-wide hover:bg-[#3bb2d5] transition rounded-xl">
        Explore Services
      </a>
    </div>
  </div>
