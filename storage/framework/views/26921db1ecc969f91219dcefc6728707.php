...
<section class="bg-gray-50 px-10 py-16">
  ...
  <div class="grid sm:grid-cols-3 gap-8 max-w-5xl mx-auto">
    <div class="p-6 bg-white rounded-xl border hover:shadow-lg transition space-y-4 flex flex-col items-center text-center">
      ...
      <h4 class="font-bold text-[#47c1ea] text-lg">Standard Shipping</h4>
      <p class="text-sm text-[#637f88]">Reliable delivery within Indonesia at the best value. Secure & on time.</p>
      <a href="#" class="mt-auto inline-block text-sm font-semibold text-[#47c1ea] hover:underline">Learn More →</a>
    </div>
    <div class="p-6 bg-white rounded-xl border hover:shadow-lg transition space-y-4 flex flex-col items-center text-center">
      <div class="text-4xl">✈️</div>
      <h4 class="font-bold text-[#47c1ea] text-lg">International Shipping</h4>
      <p class="text-sm text-[#637f88]">Send your packages worldwide with complete customs handling & tracking.</p>
      <a href="#" class="mt-auto inline-block text-sm font-semibold text-[#47c1ea] hover:underline">Learn More →</a>
    </div>
    <div class="p-6 bg-white rounded-xl border hover:shadow-lg transition space-y-4 flex flex-col items-center text-center">
      <div class="text-4xl">🚀</div>
      <h4 class="font-bold text-[#47c1ea] text-lg">Express Delivery</h4>
      <p class="text-sm text-[#637f88]">For urgent needs, we guarantee the fastest route possible, 24/7 support.</p>
      <a href="#" class="mt-auto inline-block text-sm font-semibold text-[#47c1ea] hover:underline">Learn More →</a>
    </div>
  </div>
</section>
...
<?php /**PATH D:\Jejak Tugas\crud-filament\resources\views/services.blade.php ENDPATH**/ ?>