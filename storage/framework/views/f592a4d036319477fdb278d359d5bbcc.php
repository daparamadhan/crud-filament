...
<header class="fixed top-0 left-0 right-0 z-50 flex items-center justify-between border-b px-10 py-3 bg-white shadow-md">
  <div class="flex items-center gap-4">
    ...
    <a href="<?php echo e(route('home')); ?>" class="text-lg font-bold tracking-tight hover:text-[#47c1ea] transition">Logo</a>
  </div>
...
</html><?php /**PATH D:\Jejak Tugas\crud-filament\resources\views/welcome.blade.php ENDPATH**/ ?>